...
const Add = ({token}) => {
  ...
  const [category, setCategory] = useState("Glutamine")
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        <div>
          ...
          <select onChange={(e)=>setCategory(e.target.value)} value={category} className='w-full px-3 py-2' >
            ...
            <option value="Hungry Mass">Hungry Mass</option>
            <option value="Pre Workout">Pre Workout</option>
            <option value="Hungry Whey">Hungry Whey</option>
            <option value="Hungry Multivitamin">Hungry Multivitamin</option>
            <option value="Hungry Omega-3">Hungry Omega-3</option>
          </select>
        </div>
